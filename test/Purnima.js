    ...
    it("I should be able to create my account", async () => {
      ...
      try {
        ...
        await driver
          ...
          .sendKeys("purnimamanjrekar+magento29@gmail.com");

        await driver.wait(until.elementLocated(By.id("password")), 10000);
        await driver.findElement(By.id("password")).sendKeys("Password@123");

        await driver.wait(
          until.elementLocated(By.id("password-confirmation")),
          10000
        );
        await driver
        ...
        await driver
          .findElement(By.xpath("//button[@title='Create an Account']"))
          .click();

        const information = await driver
          .findElement(By.css(".page-title-wrapper .page-title .base"))
          .getText();
        //Assert
    ...
    it("I should be able to submit the form", async () => {
      ...
      try {
        ...
        await driver
          ...
          .sendKeys("purnimamanjrekar+magento26@gmail.com");
        ...
        await driver
          ...
          .sendKeys(
            "Defective item received need to exchange soon call please"
          );
